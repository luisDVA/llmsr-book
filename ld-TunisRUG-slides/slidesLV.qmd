---
title: "Getting started with Large Language Models in R"
subtitle: "Tunis R User Group"
date: "July 31 2025"
...
A novel (2017) algorithmic architecture to help models work faster with more information
...
<br/> "All your training in data and programming was a waste of time"
:::
:::::
...
## Where are the models? </br> Who makes them?
...
Download and run smaller models on our own hardware
...
-   Never show them on calls or webinars  
...
APIs give us programmatic access to the models, so we can send requests from R, get a response, and use it directly in our workflows.
:::
...
- Suggestions are often unhelpful but harmless

## Coding with LLMs

### Chats
- Send prompts, get answers
- Often let us provide context
- Results can be copied, applied to a file, or inserted to a script
...
Browser ↩️↪️ IDE ↩️↪️ Word Processor 
...
- Available for versions 2025.07.0-204 and beyond

- Supports Anthropic for chat, GitHub Copilot for autocomplete

[Setup guide](https://positron.posit.co/assistant)
...
## Computer vision with `kuszco`

- Identify elements in images
- OCR and extract text
- Useful for alt-text and accessibility
- Now works with cloud-hosted models
...
-   Model Context Protocol (MCP): the "USB-C port for AI applications" (now possible through `mcptools` and `mcpr`)

-   Resource Augmented Generation (RAG): enhance the accuracy and reliability of LLMs with additional information from relevant data sources (nice developments with `ragnar`)
...
-   LLM-based tools are not always necessary. The answers you need may already be in the documentation, a book, your colleagues, a blog or tutorial, etc. Like take-away containers or bags at the supermarket, we do not always need them.
...
Ilya Kashnitsky and everyone that shares, gives me feedback on the guide, or points me to need tools I missed.
