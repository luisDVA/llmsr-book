...
Here's a long-form [video ](https://youtu.be/-YiRWFXNDmk?si=TbSp_HZmwjOHF9aL) of Simon Couch as a guest on the R For the Rest of Us poodcast. The interview goes through a lot of relevant AI in R topics, an includes lots of detail on using [chores](r-pkgs.qmd#chores) and [gander](r-pkgs.qmd#gander).   (**added 10/03/2025**)
</br>
