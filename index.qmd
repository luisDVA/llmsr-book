...
#### R packages
- CRAN badges!  
- `FakeDataR` for creating realistic but synthetic datasets that we can share with LLMs.

#### Other tools and extensions  
- `Roo Code` coding agent for Code OSS forks (including Positron)

#### Helpful reads
- New online book: 'AI assistants for Scientific Coding' 
- Evaluating LLM data visualizations
